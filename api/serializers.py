...
class InputSerializer(serializers.Serializer):
    ...
    def calculate_salary(cls, net_salary, allowances) -> SalaryDetails:
        ...
        tier_2_employee_contribution = (PENSION_RATES['tier_2_employee'] / 100) * net_salary
        tier_3_employee_contribution = (PENSION_RATES['tier_3_employee'] / 100) * net_salary

        employee_total_contribution = tier_1_employee_contribution + tier_2_employee_contribution + tier_3_employee_contribution
        ...
        tier_1_employer_contribution = (PENSION_RATES['tier_1_employer'] / 100) * basic_salary
        tier_3_employer_contribution = (PENSION_RATES['tier_3_employer'] / 100) * basic_salary

        employer_total_contribution = tier_1_employer_contribution + tier_3_employer_contribution

        # Calculate gross salary
        gross_salary = basic_salary + total_allowances + employer_total_contribution

        return SalaryDetails(gross_salary=gross_salary, basic_salary=basic_salary, total_paye_tax=total_paye_tax,
