...
class TestIncomeCalculatorTestCase(TestCase):
    ...
    def test_calculate_paye_tax(self):
        self.assertEqual(InputSerializer.calculate_paye_tax(self.test_data_3), 5547.4804375)

    def test_calculate_allowance(self):
        self.assertEqual(InputSerializer.calculate_total_allowances(self.test_data_1.get("allowances", [])), 0)
        self.assertEqual(InputSerializer.calculate_total_allowances(self.test_data_2.get("allowances")), 60)
...
class TestIncomeCalculatorAPITestCase(APITestCase):
    ...
    def test_endpoint_returns_200_using_data_without_allowances(self):
        ...
        self.assertEqual(response.data["employer_total_contribution"], 143.10000000000002)
